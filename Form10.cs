...
namespace WindowsFormsApp1
{
    public partial class Form10 : Form
    {
        ...
        {
            string sil = "delete from seans where id =@id";
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    baglan.Open();
                    string kayit = "insert into seans (saat)values(@saat)";
                    SqlCommand komut = new SqlCommand(kayit, baglan);
                    komut.Parameters.AddWithValue("@saat", textBox2.Text);
                    komut.ExecuteNonQuery();
        ...
        {
            baglan.Open();
            string guncelle = ("update seans set saat=@saat where id=@id");
